...
begin
  ...
  rectangle(0, 0, 639, 479); { white borders }
  setcolor(blue);
  ...
  setcolor(blue);
  line(370, 215, 355, 240); { the beginning of the star }
  ...
  line(313, 0, 313, 149); { middle blue lines }
  ...
  floodfill(636, 16, blue); { coloring white right cast }
